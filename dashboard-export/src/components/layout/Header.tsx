  ...
  return (
    <header className="flex items-center justify-between px-6 py-4 bg-surface-900 border-b border-surface-700 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-3">
        <div className={cn('flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full border', connectionStatus==='connected'?'text-emerald-400 bg-emerald-500/10 border-emerald-500/20':connectionStatus==='disconnected'?'text-red-400 bg-red-500/10 border-red-500/20':'text-gray-400 bg-gray-500/10 border-gray-500/20')}>
