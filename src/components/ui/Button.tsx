    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            // Variants
            'bg-brand-600 hover:bg-brand-500 text-white focus:ring-brand-500 shadow-sm shadow-brand-900/30':
              variant === 'primary',
            ...
            'bg-red-600/20 hover:bg-red-600/30 text-red-400 border border-red-600/30 focus:ring-red-500':
              variant === 'danger',
            'bg-transparent border border-surface-600 hover:border-brand-500 text-gray-300 hover:text-white focus:ring-brand-500':
              variant === 'outline',
